...
const initialRows = [
  createData(1, 'Test 1', 'Alteração 1', '2024-05-01', '2025-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Test 2', 'Alteração 2', '2024-05-03', '2025-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Test 3', 'Alteração 3', '2024-05-04', '2025-01-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Test 4', 'Alteração 4', '2024-05-05', '2025-01-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Test 5', 'Alteração 5', '2024-05-06', '2025-01-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Test 6', 'Alteração 6', '2024-05-07', '2025-01-08', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  return (
    <>
      <Card sx={{ backgroundColor: '#363636', color: '#333'}}>
        <CardHeader
          title="Atvidade Pratica Modulo10"
          subheader="Listagem de Modificação"
          sx={{ backgroundColor: '#836FFF', color: '#fff'}}
        />
        <CardContent>
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow sx={{ backgroundColor: '#836FFF', color: '#fff' }}>
                  <TableCell>#</TableCell>
              ...
              <TableBody>
                {tarefas.map((row, indice) => (
                  <TableRow
                    key={indice}
                    sx={{ '&:last-child td, &:last-child th': { border: 0 }, backgroundColor: indice % 2 === 0 ? '#808080' : '#D3D3D3' }}
                  >
